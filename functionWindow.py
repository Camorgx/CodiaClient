...
class Ui_functionWindow(object):
    def setupUi(self, functionWindow):
        ...
        self.label_page.setGeometry(QtCore.QRect(810, 150, 113, 64))
        self.label_page.setAlignment(QtCore.Qt.AlignCenter)
        self.label_page.setObjectName("label_page")
        self.progressBar_pack_frame = QtWidgets.QProgressBar(self.packFrame)
        self.progressBar_pack_frame.setGeometry(QtCore.QRect(0, 600, 751, 23))
        self.progressBar_pack_frame.setProperty("value", 24)
        self.progressBar_pack_frame.setObjectName("progressBar_pack_frame")
        self.label_page.raise_()
        self.listWidget_packs.raise_()
        self.pushButton_pack_OK.raise_()
        self.pushButton_next.raise_()
        self.pushButton_last.raise_()
        self.progressBar_pack_frame.raise_()
        ...
        self.pushButton_questionlist_Back.setGeometry(QtCore.QRect(810, 330, 113, 32))
        ...
        self.pushButton_Beginpack.setGeometry(QtCore.QRect(810, 420, 113, 32))
        self.pushButton_Beginpack.setObjectName("pushButton_Beginpack")
        self.label_deadline = QtWidgets.QLabel(self.exerciseFrame)
        self.label_deadline.setGeometry(QtCore.QRect(800, 150, 140, 32))
        self.label_deadline.setAlignment(QtCore.Qt.AlignCenter)
        self.label_deadline.setObjectName("label_deadline")
        self.progressBar_question_frame = QtWidgets.QProgressBar(self.exerciseFrame)
        self.progressBar_question_frame.setGeometry(QtCore.QRect(0, 600, 751, 23))
        self.progressBar_question_frame.setProperty("value", 24)
        self.progressBar_question_frame.setObjectName("progressBar_question_frame")
        self.listWidget_questions.raise_()
        self.pushButton_questionlist_OK.raise_()
        self.pushButton_questionlist_Back.raise_()
        self.pushButton_Beginpack.raise_()
        self.label_deadline.raise_()
        self.progressBar_question_frame.raise_()
    ...
    def retranslateUi(self, functionWindow):
        ...
        self.label_deadline.setText(_translate("functionWindow", "<html><head/><body><p>截止日期：</p><p>无限制"))
