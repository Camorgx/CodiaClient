...
def Reset():
    ...
    if ((not ResetUi.lineEdit_Check_NewPassword.text()) or (not ResetUi.lineEdit_NewPassword.text())
        ...
        return
    try:
        change_password(ResetUi.lineEdit_CheckNum.text(),
                        ResetUi.lineEdit_NewPassword.text(), ResetUi.lineEdit_Check_NewPassword.text())
        ...
        if 'Invalid password' in str(e):
            ...
            QMessageBox.critical(None, '错误', str(e), QMessageBox.Ok)
    else:
