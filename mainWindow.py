...
class Ui_windowMain(object):
    def setupUi(self, windowMain):
        ...
        self.labelQuestionStatus = QtWidgets.QLabel(self.frameHistory)
    ...
    def retranslateUi(self, windowMain):
        ...
        self.pushButtonSubmit.setText(_translate("windowMain", "提交"))
