...
class Ui_windowMain(object):
    def setupUi(self, windowMain):
        ...
        self.labelQuestionStatus.setGeometry(QtCore.QRect(0, 0, 180, 30))
        self.labelQuestionStatus.setIndent(10)
        ...
        self.comboBoxLanguage.setGeometry(QtCore.QRect(901, 0, 151, 30))
        ...
        self.comboBoxLanguageSubmit.setGeometry(QtCore.QRect(901, 0, 151, 30))
        ...
        self.labelSubmitStatus.setGeometry(QtCore.QRect(0, 0, 180, 30))
        self.labelSubmitStatus.setIndent(10)
